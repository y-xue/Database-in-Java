...
public class Tuple implements Serializable {
    ...
    private RecordId rid; // Maybe final
    ...
    public static Tuple merge(Tuple tuple1, Tuple tuple2) {
    		TupleDesc mergedTupleDesc = TupleDesc.merge(tuple1.getTupleDesc(), tuple2.getTupleDesc());
		...
		for (int i = 0; i < numFields2; i++)
			mergedTuple.setField(i + numFields1, tuple2.getField(i));

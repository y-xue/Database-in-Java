...
public class HeapPage implements Page {
    ...
    private TransactionId dirtyTranscationId;
...
//    throw new UnsupportedOperationException("implement this");
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        int slot = recordId.getTupleNumber();
        if (!this.pid.equals(recordId.getPageId()))
            throw new DbException("Tuple to delete doesn't exist");
        if (!isSlotUsed(slot))
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        // not necessary for lab1
            ...
            throw new DbException("Fail matching TupleDesc");
        }
	...
	// not necessary for lab1
    		if (dirty) {
            dirtyTranscationId = tid;
        } else {
            dirtyTranscationId = null;
        }
    }
...
//    			int j = 0;
//    			while (j++ < 8) {
//    				numFilled += headerByte & 1;
//    				headerByte >>= 1;
//    			}
//    		}
//    		int total = getNumTuples();
//        return (total - numFilled);
    }

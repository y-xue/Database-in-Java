...
public class Join extends Operator {
    ...
    private Iterator<Tuple> joinedTupleIterator;
    /**
    		...
    		while (child1.hasNext()) {
    			...
    			while (child2.hasNext()) {
    				...
    				if (joinPredicate.filter(tuple1, tuple2))
    					joinedTuples.add(Tuple.merge(tuple1, tuple2));
    			}
    			child2.rewind();
    		}
    		joinedTupleIterator = joinedTuples.iterator();
    		super.open();
    }
    ...
    protected Tuple fetchNext() throws TransactionAbortedException, DbException {
        // some code goes here
    		if (joinedTupleIterator != null && joinedTupleIterator.hasNext())
    			return joinedTupleIterator.next();
        return null;
    }
